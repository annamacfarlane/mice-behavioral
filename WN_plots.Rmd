...
jpeg(file = '/Users/AnnaMacFarlane/Desktop/AWN_ctrl_facetAgeSex.jpeg')
...
animal_counts<-distinct(e_trials_ctrl, AnimalID, .keep_all = TRUE)
table(animal_counts[animal_counts$Genotype == 'APOE44', ]$Age_group)
