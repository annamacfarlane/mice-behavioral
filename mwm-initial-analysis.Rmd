...
probe_summary <- probe_trials %>% 
  group_by(Stage, APOE, Diet, Sex) %>% 
  summarize(
    sd = sd(NormSWDist, na.rm = TRUE),
    NormSWDist = mean(NormSWDist)
  )

probe_summary

ggplot(probe_summary, aes(x=Stage, y=NormSWDist, group = 1, 
                        color = APOE, fill = APOE)) + 
  geom_line() + 
  geom_point() +
  #geom_errorbar(aes(x=Stage, y=NormSWDist, ymin=len-sd,ymax=len+sd),
  #              data = probe_summary,
  #              inherit.aes = FALSE)+
  geom_errorbar(aes(ymin=NormSWDist-sd, ymax=NormSWDist+sd), width=.2,
...
ggline(probe_trials, x='Stage', y='NormSWDist',
       color='APOE', fill='APOE', facet.by='Diet', 
...
```{r probe-dist}
ggline(probe_trials, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')

ggline(hn_probe, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')

ggline(e_probe, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')

ggline(e2_probe, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')

ggline(e3_probe, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')

ggline(e4_probe, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, legend='top')
```
...
ggline(hn_trials, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')

ggline(e_trials, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')

ggline(e2, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')

ggline(e3, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')

ggline(e4, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red','pink','gray','blue', 'orange'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')
