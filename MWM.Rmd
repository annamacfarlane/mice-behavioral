...
# dfAveraged<-aggregate(dfFin, by=list(dfFin$Animal,dfFin$APOE,dfFin$Sex,dfFin$Stage), FUN=mean, na.action=na.pass)
dfAveraged<-aggregate(Animal ~ NormSWTime, dfFin, FUN = function(x) mean(as.numeric(as.character(x))))
